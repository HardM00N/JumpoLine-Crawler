...
for market_card in market_cards:
    ...
    if title.text == "공유매물직거래":
        ...
        text_box.send_keys('안녕하세요. 점포라인 이하늘 공인중개사입니다.\n 현재 저희 점포라인에 접수되어 있는 대표님의 매장을 보다 빠르게 거래시켜드리기 위해서 문자 남깁니다.\n 빠른거래를 원하시면 저에게 문자를 남겨주시고 기다리시면 제가 직접 전화통화 후 방문하여 상담해드리고 있습니다.')
